...
<html>
    <head>
        <meta charset="utf-8">
        <title>Escalerilla, Manquehue</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
	 <link rel="shortcut icon" href="logoclubmanquehue.jpg" />
        ...
        <div class="navbar navbar-info navbar-fixed-top">
            <div class="navbar-inner"><!-- navbar -->
                <div class="container-fluid">
                    ...
                    <img src="img/logoclubmanquehue.jpg" width="40" height="70" class="pull-left">
                    <a class="brand" href="index.php">Escalerilla Manquehue 2013</a>
